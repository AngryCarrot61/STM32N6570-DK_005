...
#define DISPLAY_NO_OF_FRAMEBUFFERS    1
...
typedef struct
{
  ...
  uint16_t R:5;
  /* MSB */
} __attribute__((packed)) Color_RGB565_t;
...
extern Color_RGB565_t FrameBuffer[DISPLAY_NO_OF_FRAMEBUFFERS][DISPLAY_SIZE_H][DISPLAY_SIZE_W] __attribute__((section("Nemagfx_Framebuffer")));
...
extern Color_RGBA8888_t FrameBuffer[DISPLAY_NO_OF_FRAMEBUFFERS][DISPLAY_SIZE_H][DISPLAY_SIZE_W] __attribute__((section("Nemagfx_Framebuffer")));
#endif
