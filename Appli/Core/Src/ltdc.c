...
void MX_LTDC_Init(void)
{
  ...
  pLayerCfg.WindowX1 = DISPLAY_SIZE_W;
  pLayerCfg.WindowY0 = 0;
  pLayerCfg.WindowY1 = DISPLAY_SIZE_H;
  ...
  pLayerCfg.FBStartAdress = (uint32_t)FrameBuffer[0];
  pLayerCfg.ImageWidth = DISPLAY_SIZE_W;
  pLayerCfg.ImageHeight = DISPLAY_SIZE_H;
  pLayerCfg.Backcolor.Blue = 0x40;
  ...
  pLayerCfg1.FBStartAdress = (uint32_t) FrameBuffer[1];
